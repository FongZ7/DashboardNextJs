                ...
                <div className='flex justify-center items-center'>
                    <div className='w-[400px] shadow-xl p-10 mt-5 rounded-xl'>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <input type="emial" onChange={(e) => setEmail(e.target.value)} className='w-full bg-gray-200 border py-2 px-3 rounded text-lg my-2' placeholder='Enter your email'/>
                            ...
                            <button className='bg-green-500 text-white py-2 px-3 border rounded text-lg my-2' type='submit'>Sign Up</button>
                            <hr className='my-3 '/>
                            <p>
