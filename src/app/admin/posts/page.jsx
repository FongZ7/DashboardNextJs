                                ...
                                <table className='text-left rounded-md mt-3 table-fixed w-full'>
                                    <thead>
                                        <tr className='bg-gray-400'>
                                            ...
                                            <th className='p-5'>Post Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {allPostsData?.map((val, index) => (
                                            <tr key={val._id}>
                                                <td className='p-5'>{val.id}</td>
                                                ...
                                                <td className='p-5'>
                                                    <Link className='bg-gray-500 text-white border py-2 px-3 rounded text-lg my-2' href={`/admin/posts/edit/${val.id}`}>Edit</Link>
