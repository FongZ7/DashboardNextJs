...
function Content({ totalUsersData, totalPostsData }) {
  return (
    <div className='px-10 rounded-lg'>
        ...
        <p>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Velit quisquam facere id iste nesciunt quia cum corporis! Recusandae repellendus cumque, officia nulla dicta porro beatae, minus qui magnam facilis atque.
        </p>
    </div>
  )
}
